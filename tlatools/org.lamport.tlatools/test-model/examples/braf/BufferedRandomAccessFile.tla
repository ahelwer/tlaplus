...
Postcondition ==
  CounterExample =
[action |-> {<<<<1, [dirty |-> FALSE, length |-> 0, curr |-> 0, lo |-> 0, buff |-> [elems |-> <<ArbitrarySymbol, ArbitrarySymbol>>], diskPos |-> 0, file_content |-> [elems |-> <<>>], file_pointer |-> 0]>>, [name |-> "WriteAtMost", location |-> [beginLine |-> 200, beginColumn |-> 5, endLine |-> 209, endColumn |-> 60, module |-> "BufferedRandomAccessFile"], context |-> [data |-> [elems |-> <<A, B>>]], parameters |-> <<"data">>], <<2, [dirty |-> TRUE, length |-> 2, curr |-> 2, lo |-> 0, buff |-> [elems |-> <<A, B>>], diskPos |-> 0, file_content |-> [elems |-> <<>>], file_pointer |-> 0]>>>>, <<<<2, [dirty |-> TRUE, length |-> 2, curr |-> 2, lo |-> 0, buff |-> [elems |-> <<A, B>>], diskPos |-> 0, file_content |-> [elems |-> <<>>], file_pointer |-> 0]>>, [name |-> "SetLength", location |-> [beginLine |-> 148, beginColumn |-> 5, endLine |-> 163, endColumn |-> 30, module |-> "BufferedRandomAccessFile"], context |-> [newLength |-> 0], parameters |-> <<"newLength">>], <<3, [dirty |-> TRUE, length |-> 0, curr |-> 0, lo |-> 0, buff |-> [elems |-> <<ArbitrarySymbol, ArbitrarySymbol>>], diskPos |-> 2, file_content |-> [elems |-> <<>>], file_pointer |-> 2]>>>>, <<<<3, [dirty |-> TRUE, length |-> 0, curr |-> 0, lo |-> 0, buff |-> [elems |-> <<ArbitrarySymbol, ArbitrarySymbol>>], diskPos |-> 2, file_content |-> [elems |-> <<>>], file_pointer |-> 2]>>, [name |-> "SetLength", location |-> [beginLine |-> 148, beginColumn |-> 5, endLine |-> 163, endColumn |-> 30, module |-> "BufferedRandomAccessFile"], context |-> [newLength |-> 0], parameters |-> <<"newLength">>], <<3, [dirty |-> TRUE, length |-> 0, curr |-> 0, lo |-> 0, buff |-> [elems |-> <<ArbitrarySymbol, ArbitrarySymbol>>], diskPos |-> 2, file_content |-> [elems |-> <<>>], file_pointer |-> 2]>>>>}, state |-> {<<1, [dirty |-> FALSE, length |-> 0, curr |-> 0, lo |-> 0, buff |-> [elems |-> <<ArbitrarySymbol, ArbitrarySymbol>>], diskPos |-> 0, file_content |-> [elems |-> <<>>], file_pointer |-> 0]>>, <<2, [dirty |-> TRUE, length |-> 2, curr |-> 2, lo |-> 0, buff |-> [elems |-> <<A, B>>], diskPos |-> 0, file_content |-> [elems |-> <<>>], file_pointer |-> 0]>>, <<3, [dirty |-> TRUE, length |-> 0, curr |-> 0, lo |-> 0, buff |-> [elems |-> <<ArbitrarySymbol, ArbitrarySymbol>>], diskPos |-> 2, file_content |-> [elems |-> <<>>], file_pointer |-> 2]>>}]
===============================================================================
...
CONSTANTS
    ...
    A, B, \* the individual data symbols (elements of Symbols); declared so counterexample traces can name them
