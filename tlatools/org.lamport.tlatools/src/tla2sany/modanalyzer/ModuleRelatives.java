...
public class ModuleRelatives {
   ...
   */
  Vector<ModulePointer> directInnerModules = new Vector<>();
   ...
   * current ParseUnit
   */
  Vector<String> directlyExtendedModuleNames = new Vector<>();
   ...
   * current ParseUnit
   */
  Vector<String> directlyInstantiatedModuleNames = new Vector<>();
