    ...
    ***********************************************************************/
    ...
    for (int i = 0; i < children.length; i++) {
      ...
      if (! (   child.isKind(N_ConjList)
         ...
         if (!junctionListCtx.isAboveCurrent(child.location[1])) {
...
//
  ...
  private final String msgStackToString(ParseException e) {
    ...
    if ( !emptyString.equals(expecting) ) {
...
SyntaxTreeNode tn;
int kind ;
    if (jj_2_38(2) && (junctionListCtx.isAboveCurrent( getToken(1).beginColumn))) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case op_76:
      case op_26:
      case op_29:
    ...
    } else if (jj_2_39(2147483647) && (junctionListCtx.isAboveCurrent( getToken(1).beginColumn))) {
      /***********************************************************************
          * Need the junction list column check to make sure that the LAMBDA     *
...
***************************************************************************/
  ...
  junctionListCtx.startNewJunctionList(getToken(1).beginColumn, getToken(1).kind);
    /***********************************************************************
    * Indicate start of new junction list, identified by token type and    *
    * column of first character in the /\ or \/ token.                     *
    ***********************************************************************/
  ...
  SyntaxTreeNode tn;
    ...
    label_44:
    while (true) {
      if (junctionListCtx.isNewBullet( getToken(1).beginColumn, getToken(1).kind )) {
        ;
      } else {
        break label_44;
      }
...
***************************************************************************/
  ...
  OperatorStack.newStack();
    ...
    if (jj_2_55(2147483647) && (junctionListCtx.isAboveCurrent( getToken(1).beginColumn))) {
      tn = OpenExpression();
                          OperatorStack.pushOnStack( tn, null );
    } else if (junctionListCtx.isAboveCurrent( getToken(1).beginColumn)) {
      ExtendableExpr();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  Token t;
  bpa("ExtendableExpr") ;
    if (jj_2_56(2147483647) && (OperatorStack.preInEmptyTop())) {
      tn = Junctions();
                      OperatorStack.pushOnStack( tn, null );
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    while (true) {
      ...
      if (jj_2_59(2147483647) && (junctionListCtx.isAboveCurrent( getToken(1).beginColumn))) {
        tn = PostfixOp();
       heirs = new SyntaxTreeNode[2];
       heirs[0] =
       ...
       OperatorStack.pushOnStack(new SyntaxTreeNode(mn, N_GenPostfixOp, heirs),
                                 lastOp);
       if (OperatorStack.size() != 1) {OperatorStack.reduceStack();} ;
      } else if (jj_2_60(2147483647) && (junctionListCtx.isAboveCurrent( getToken(1).beginColumn))) {
        t = jj_consume_token(DOT);
       Token next = getToken(1);
       if (isFieldNameToken( next )) next.kind = IDENTIFIER;
      ...
      } else if (jj_2_61(2147483647) && (junctionListCtx.isAboveCurrent( getToken(1).beginColumn))) {
    ...
    if (jj_2_66(1)) {
      if (jj_2_64(2147483647) && (junctionListCtx.isAboveCurrent( getToken(1).beginColumn))) {
        tn = InfixOp();
     heirs = new SyntaxTreeNode[2];
     heirs[0] = new SyntaxTreeNode( mn, N_IdPrefix, (SyntaxTreeNode []) null);
     heirs[1] = tn ;
     ...
     if (OperatorStack.size() != 1) {OperatorStack.reduceStack();} ;
      ...
      if (OperatorStack.size() != 1) {OperatorStack.reduceStack();} ;
        ...
        if (jj_2_63(2147483647) && (junctionListCtx.isAboveCurrent( getToken(1).beginColumn))) {
          tn = OpenExpression();
                            OperatorStack.pushOnStack( tn, null );
        } else if (junctionListCtx.isAboveCurrent( getToken(1).beginColumn)) {
          ExtendableExpr();
      ...
      } else if (jj_2_65(2147483647) && (junctionListCtx.isAboveCurrent( getToken(1).beginColumn))) {
        t = jj_consume_token(COLONCOLON);
  ...
  bpa("Primitive expression") ;
    if (jj_2_69(2147483647) && (junctionListCtx.isAboveCurrent( getToken(1).beginColumn))) {
      tn = String();
    } else if (jj_2_70(2147483647) && (junctionListCtx.isAboveCurrent( getToken(1).beginColumn))) {
      tn = Number();
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case op_57:
...
// ", correctedImage = " + tn0.image) ;
  ...
  *************************************************************************/
  ...
  final private boolean jj_3R_109() {
    ...
    lookingAhead = false;
    if (!jj_semLA || jj_scan_token(287)) return true;
    }
    }
    }
    }
  ...
  final private boolean jj_3R_95() {
    ...
    xsp = jj_scanpos;
    lookingAhead = true;
    jj_semLA = junctionListCtx.isAboveCurrent( getToken(1).beginColumn);
    lookingAhead = false;
  ...
  static {
   ...
   private static void jj_la1_3() {
      jj_la1_3 = new int[] {0xffc00200,0xffe00000,0x0,0x1e0000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1e0000,0xffe00000,0x0,0x0,0x0,0xffe00000,0x0,0x0,0xffe00000,0x0,0xffe00000,0x0,0x0,0x0,0x1e0000,0xffe00000,0x0,0x0,0xfffe0000,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffe00000,0x0,0x0,0x0,0xffe00000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x52,0x0,0x0,0xfffe0000,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x40,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40c,0x2,0x0,0x2,0x0,0x180,0x200,0x52,0x0,0x1,0x1,0x0,0x40,0x0,0xffc00200,0x52,0xffc00200,0x0,0x1e0000,0x200,0xfffe0000,0xfffe0000,0x0,0x2140,0x0,};
   }
   ...
   private static void jj_la1_8() {
      jj_la1_8 = new int[] {0x0,0x0,0x7fffffff,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7fffffff,0x80000000,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x80000000,0x0,0x0,0x0,0x7fffffff,0x0,0x0,0x0,0xffffffff,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x7fffffff,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x80000000,0x0,0x7fffffff,0x0,0x7fffffff,0x0,0xffffffff,0x0,0xffffffff,0x7fffffff,0x0,0x0,0x0,};
   }
   private static void jj_la1_9() {
      jj_la1_9 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1f,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3,0x3,0x0,0x3,0x0,0x0,0x0,0x0,};
   }
