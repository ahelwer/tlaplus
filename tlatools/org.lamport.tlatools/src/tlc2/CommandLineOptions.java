...
public class CommandLineOptions
{
	...
	/**
	 * Whether to model check the spec.
	 * Ignored, kept for backward compatibility; model checking is default behavior.
	 */
	 ...
	 * Ignored, kept for backward compatibility; spec generated by default.
	 */
	public boolean generateTraceExpressionSpecFlag = false;
	
	/**
	 * Whether to skip generating a trace expression spec.
	 */
	public boolean noGenerateTraceExpressionSpecFlag = false;
	
	/**
	 * Whether to create a monolithic trace expression spec.
	 * Ignored, kept for backward compatibility; functionality no longer exists.
	 */
	public boolean noMonolithTraceExpressionSpecFlag = false;
	...
	public static OneOf<FailedParseResult, HelpRequestParseResult, SuccessfulParseResult> parse(String[] args)
	{
		...
		try
		{
			...
			while (index < args.length)
			{
				...
				{
					index++;
					options.generateTraceExpressionSpecFlag = true;
